...
//             <Button variant="ghost" size="icon" className="lg:mr-4">
...
//         {/* Content Section with imgs */}
//         <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
//           {/* Left Side - Large img and CTA */}
...
//             <div className="pt-4">
//               <Button
//                 className=" text-gray-900 hover:bg-gray-300 hover:text-black px-8 py-3 text-lg font-semibold bg-transparent"
//               >
//                 GET STARTED FREE
...
//           {/* Right Side - Description and Smaller img */}
//           <div className="space-y-6">
//             {/* Description Text */}
...
//             {/* Smaller img with Overlay Button */}
//             <div className="relative">
//               <img
//                 src="/image (2).png"
...
//                 <Button className="bg-orange-500 hover:bg-orange-600 text-white text-sm px-2 py-2 font-medium rounded-full">
