...
const cardsData = [
    {
        ...
        description: "Instantly calculate import duties, taxes, and fees before you ship.",
        leftIcon: Grid1Img,
    ...
    },
    {
        ...
        description: "Find the correct customs code to avoid clearance delays and penalties.",
        leftIcon: Grid2Img,
        rightIcon: UseToolBtnImg,
        colSpan: 1
    },
    {
        ...
        description: "Get accurate shipping quotes across multiple carriers in seconds.",
        leftIcon: Grid3Img,
        rightIcon: UseToolBtnImg,
        colSpan: 1
    },
    {
        ...
        description: "Ensure every supplier you work with is legitimate by instantly verifying their business licenses, certifications, and past trading records. Our tool provides a detailed background check, helping you confirm legal status and industry compliance before making any commitments.",
        leftIcon: Grid4Img,
        rightIcon: UseToolBtnImg,
        colSpan: 2
    },
    {
        id: 5,
        title: "Route Planner",
        description: "Optimize your cargo routes to save time and reduce transport risks.",
        leftIcon: Grid5Img,
        rightIcon: UseToolBtnImg,
        colSpan: 1
    },
    {
        ...
        description: "Create compliant invoices, packing lists, and certificates in minutes.",
        leftIcon: Grid1Img,
        rightIcon: UseToolBtnImg,
        colSpan: 1
    },
    ...
    },
    {
        ...
        description: "Spot storage fees, handling charges, and other unexpected costs early.",
        leftIcon: Grid3Img,
        rightIcon: UseToolBtnImg,
        colSpan: 1
    }
                ...
                <div className="relative z-10 w-full max-w-7xl mx-auto">
                    <div className="max-w-4xl mx-auto text-center sm:text-left">
                        ...
                        <p className="text-white text-base sm:text-lg lg:text-xl mb-6 sm:mb-8 max-w-lg mx-auto sm:mx-0 leading-relaxed">
                            Everything you need to trade confidently — from cost calculators to fraud protection.
                        </p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-24 items-center">
                        ...
                        <div className="space-y-6 sm:space-y-8 order-2 lg:order-1">
                            ...
                            <p className="text-gray-600 text-base sm:text-lg leading-relaxed text-center lg:text-left">
                                Trade without guesswork. From calculating your true import costs to verifying suppliers and spotting fraud risks, our smart tools help you ship faster, safer, and with full confidence.
                            </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {cardsData.map((card) => (
                            <div
                                key={card.id}
                                className={`${
                                    card.colSpan === 2 ? 'md:col-span-2 lg:col-span-2' : 'col-span-1'
    ...
    const faqData = [
        {
            ...
            answer: "Car service is essential for maintaining the performance and maintaining the performance and longevity Car service is essential for maintaining"
        },
        {
            id: 2,
            question: "What are the signs of brake wear?",
            answer: "Common signs include squeaking or grinding noises, vibration when braking, longer stopping distances, and the brake pedal feeling soft or spongy."
        },
        {
            id: 3,
            question: "Can regular maintenance prevent major repairs?",
            answer: "Yes, regular maintenance can significantly reduce the likelihood of major repairs by catching issues early and keeping your vehicle systems running efficiently."
        },
        {
            id: 4,
            question: "Are scheduled service intervals important for my car?",
            answer: "Absolutely. Following scheduled service intervals helps maintain warranty coverage, ensures optimal performance, and prevents costly breakdowns."
        }
    ]
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-12 sm:mb-16">
                    ...
                    <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                        Got Questions? We've<br className="hidden sm:block" />
                        Got Answers
                    </h2>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 items-start">
                    ...
                    <div className="space-y-4 sm:space-y-6">
                        {faqData.map((faq, index) => (
                            <div key={faq.id} className="border-b border-gray-200 pb-4 sm:pb-6">
                                <button
